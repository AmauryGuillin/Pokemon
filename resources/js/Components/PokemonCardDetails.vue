...
import AttacksDialog from "@/Components/AttacksDialog.vue";
  ...
  <div class="grid grid-cols-[33%_33%_33%] items-center justify-center text-center">
    <div class="flex flex-col justify-center items-center border-r-2 border-gray-300 h-full space-y-5">
      <div class="flex justify-center items-center gap-2">
          <span>
            <svg class="lucide lucide-weight" fill="none" height="24" stroke="currentColor"
                 stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                 width="24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="5" r="3"/><path
    ...
    <div class="flex flex-col justify-center items-center h-full space-y-5">
      <div class="flex justify-center items-center gap-2">
          <span>
            <svg class="lucide lucide-swords" fill="none" height="24" stroke="currentColor"
                 stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                 width="24" xmlns="http://www.w3.org/2000/svg"><polyline
      ...
      <div class="flex justify-center items-center gap-4 ">
        ...
        <div>
          <AttacksDialog :objects="objects" :pokemon="pokemon"/>
        </div>
      </div>
    </div>
  </div>
